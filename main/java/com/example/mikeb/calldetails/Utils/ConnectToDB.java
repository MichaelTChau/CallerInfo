...
public class ConnectToDB {
    public String getNumber(String query){
        ...
        try {
            URL url = new URL(ContactUtils.base_url+query);
    ...
    public void insert(String query){
        try {
            ...
            URL object=new URL(contactUtils.base_url);
    ...
    public String lookupNumber(String object){
        String urlString = "https://api.mlab.com/api/1/databases/phone_number_profiles/collections/profiles?q=";
